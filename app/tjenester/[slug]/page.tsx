...
const services = {
  "totaloppussing-av-bad": {
    ...
    description:
      "Vi leverer komplette løsninger for full renovering av bad og våtrom – utført med fokus på kvalitet, trygghet og varig resultat. Med solid fagkunnskap og erfaring fra våtromsarbeid følger vi gjeldende krav i Byggebransjens våtromsnorm (BVN) og TEK17, slik at du får et bad som både ser bra ut og tåler tidens bruk.",
    image: "/totaloppusing.jpg",
    points: [
      "Design: Utarbeide skisse og materialvalg",
      "Utførelse: Demontering, bygging og installasjon",
      "Våtromsarbeid: Membran og tetting i tråd med BVN og TEK17",
    ...
    metaTitle: "Baderomsrenovering og våtrom i Oslo og Akershus | Varige Bad",
    metaDescription:
      "Full renovering av bad og våtrom fra design til ferdigstillelse. Vi følger BVN og TEK17, og leverer trygge baderom som tåler tidens bruk i Oslo og Akershus.",
    keywords: [
      ...
      "TEK17 baderom",
      "membran våtrom",
      "godkjent våtromsarbeid",
      "baderomsrenovering Vestre Aker",
      "baderomsrenovering Ullern",
      "baderomsrenovering Frogner",
      "baderomsrenovering St. Hanshaugen",
      "baderomsrenovering Sagene",
      "baderomsrenovering Grünerløkka",
      "baderomsrenovering Gamle Oslo",
      "baderomsrenovering Nordstrand",
      "baderomsrenovering Søndre Nordstrand",
      "baderomsrenovering Østensjø",
      "baderomsrenovering Alna",
      "baderomsrenovering Grorud",
      "baderomsrenovering Stovner",
      "baderomsrenovering Bjerke",
      "baderomsrenovering Nordre Aker",
      "baderomsrenovering Bærum",
      "baderomsrenovering Asker",
      "baderomsrenovering Lillestrøm",
  ...
  flislegging: {
    title: "Flislegging",
    description:
      "Flislegging er en viktig del av en god baderomsrenovering, men handler ikke bare om utseende – det krever nøyaktighet, riktig underlag og godt håndverk. Som en del av våre komplette våtromsløsninger leverer vi flisarbeid av høy kvalitet, tilpasset ditt bad og dine ønsker. Rette linjer, god fall og et varig resultat – hver gang.",
    image: "/Flislegger.webp",
    points: ["Bad", "Kjøkken", "Gang", "Veranda", "Garasje"],
    metaTitle: "Flislegging i Oslo og Akershus | Varige Bad",
    metaDescription:
      "Profesjonell flislegging som del av komplett baderomsrenovering, samt fliser til kjøkken, gang, veranda og garasje, i Oslo og Akershus.",
    keywords: [
      "flislegging Oslo",
      "flislegger Akershus",
      "flislegging bad",
