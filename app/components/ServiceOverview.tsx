...
const servicesSummary: ServiceSummary[] = [
  {
    ...
    shortDescription:
      "Komplett renovering fra riving til ferdig resultat, i tråd med BVN og TEK17.",
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-7 flex flex-col gap-4 sm:mb-9 md:flex-row md:items-end md:justify-between lg:mb-10">
          <div>
            ...
            >
              Alt du behøver for ditt baderomsprosjekt
            </h2>
          </div>
          <Link
            href="/tjenester"
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-4 lg:gap-6">
          {servicesSummary.map((service) => (
            ...
            >
              {/* Bilde — høyde skalerer i tre steg, ikke bare to */}
